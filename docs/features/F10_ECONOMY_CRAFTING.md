# F10 - ECONOMY CRAFTING

## Visao tecnica

Esta task define a implementacao de `F10` no modo `survival/economy/hybrid`.

Objetivo central:

- Sistema material de crafting e construcao

## Requisitos de mapa e escala

Mapa maior exige distribuicao balanceada de recurso por quadrante.
...
Introduz `craft_station`, `storage_box`, `structure_tile`.
...
Dependencias: inventario, crafting recipes, build rules.
