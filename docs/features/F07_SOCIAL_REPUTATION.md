# F07 - SOCIAL REPUTATION

## Visao tecnica

Esta task define a implementacao de `F07` no modo `survival`.

Objetivo central:

- Aliancas, traicao e reputacao relacional

## Requisitos de mapa e escala

Mapa maior amplia distancia social; incluir metrica de proximidade em interacoes.
...
Opcional `alliance_marker` para visualizacao de pacto.
...
- `POST /agents/{id}/alliances`
- `POST /agents/{id}/betray`
...
Dependencias: memoria relacional + eventos sociais.
