...
Esta task define a implementacao de `F03` no modo `all`.

Objetivo central:

- Inspecao detalhada da cadeia de decisao do agente

## Requisitos de mapa e escala

Sem dependencia direta de tamanho de mapa; deve exibir coordenadas corretas em mundo >20.
...
Opcional `focus_marker` para destacar alvo/area da decisao.
...
Dependencias: decision_log, memory_store, endpoints de leitura.
