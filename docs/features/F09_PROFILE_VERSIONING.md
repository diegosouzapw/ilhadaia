# F09 - PROFILE VERSIONING

## Visao tecnica

Esta task define a implementacao de `F09` no modo `all`.

Objetivo central:

- Versionamento auditavel de perfis e prompts

## Requisitos de mapa e escala

Sem dependencia de mapa.
...
- `POST /profiles/{id}/activate/{version}`
...
Dependencias: storage de versoes de profile e ativacao.
