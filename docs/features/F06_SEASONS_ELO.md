...
Esta task define a implementacao de `F06` no modo `all`.

Objetivo central:

- Temporadas e ranking historico por perfil

## Requisitos de mapa e escala

Registrar tamanho de mapa e modo como dimensoes da temporada.
...
Dependencias: session_store com historico de rodadas.
