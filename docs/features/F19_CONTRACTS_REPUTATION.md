# F19 - CONTRACTS REPUTATION

## Visao tecnica

Esta task define a implementacao de `F19` no modo `economy/gincana/hybrid`.

Objetivo central:

- Contratos de entrega e reputacao comercial

## Requisitos de mapa e escala

Contratos devem validar origem/destino em mapa maior sem hardcode.
...
Objetos: `contract_terminal`, `delivery_marker`.
...
Dependencias: contratos ativos por agente e reputacao.
