# F17 - LOCAL ECONOMY MODE

## Visao tecnica

Esta task define a implementacao de `F17` no modo `economy`.

Objetivo central:

- Modo economia local orientado a lucro e abastecimento

## Requisitos de mapa e escala

Mapa recomendado 36x36 com postos em regioes distintas.
...
Objetos: `market_post`, `storage_box`, `trade_route_marker`.
...
Dependencias: moeda, inventario comercial e market posts.
