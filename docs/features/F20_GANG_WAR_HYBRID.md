...
Esta task define a implementacao de `F20` no modo `hybrid`.

Objetivo central:

- Modo premium combinando guerra e logistica

## Requisitos de mapa e escala

Mapa recomendado 44x44 com macro-zonas e corredores de supply.
...
Objetos: combina warfare + economy + `black_market` + `sabotage_target`.
...
Dependencias: F13+F16 + F17+F19 integrados.
