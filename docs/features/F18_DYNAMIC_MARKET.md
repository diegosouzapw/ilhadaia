...
Esta task define a implementacao de `F18` no modo `economy/hybrid`.

Objetivo central:

- Preco dinamico por oferta e demanda

## Requisitos de mapa e escala

Calculo de mercado deve considerar distancia logistica no mapa.
...
Objetos: `price_board`, `market_post`.
...
Dependencias: telemetria de oferta/demanda por item.
