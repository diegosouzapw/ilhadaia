# F11 - WEBHOOK PLATFORM

## Visao tecnica

Esta task define a implementacao de `F11` no modo `all`.

Objetivo central:

- Plataforma de eventos externos com entrega confiavel

## Requisitos de mapa e escala

Eventos devem incluir `map_size` e `game_mode` no payload.
...
Dependencias: webhook manager + eventos de dominio.
