...
Esta task define a implementacao de `F15` no modo `warfare`.

Objetivo central:

- Papeis taticos por agente de equipe

## Requisitos de mapa e escala

Sem dependencia direta de tamanho; precisa de spawn coerente por base.
...
Dependencias: composicao de equipe e role context no thinker.
