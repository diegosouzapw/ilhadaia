...
Esta task define a implementacao de `F12` no modo `gincana`.

Objetivo central:

- Modo de desafios de coleta e objetivo

## Requisitos de mapa e escala

Mapa recomendado 28-36; templates devem definir zonas e checkpoints.
...
Objetos: `checkpoint`, `artifact`, `goal_zone`.
...
Dependencias: F08 + F04 para desafios dinamicos.
