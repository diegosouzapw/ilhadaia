# F13 - WARFARE FACTIONS

## Visao tecnica

Esta task define a implementacao de `F13` no modo `warfare`.

Objetivo central:

- Modo guerra de faccoes 4v4

## Requisitos de mapa e escala

Mapa recomendado 40x40 com duas bases e corredores centrais.
...
Objetos: `team_base`, `supply_crate`, `control_zone`.
...
Dependencias: separacao por time + condicao de round.
