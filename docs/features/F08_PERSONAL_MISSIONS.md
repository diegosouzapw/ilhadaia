# F08 - PERSONAL MISSIONS

## Visao tecnica

Esta task define a implementacao de `F08` no modo `survival/gincana/economy`.

Objetivo central:

- Objetivos individuais com score dedicado

## Requisitos de mapa e escala

Missoes espaciais devem adaptar distancia ao tamanho do mapa.
...
Usa `mission_marker`, `checkpoint`, `delivery_marker`.
...
Dependencias: sistema de objetivos por agente/sessao.
